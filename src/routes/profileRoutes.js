...
router.post(
  ...
  [
    ...
    body('usnapVideoUrl').optional({ nullable: true, checkFalsy: true }).isURL({ require_protocol: true }),
    body('usnapThumbnailUrl').optional({ nullable: true, checkFalsy: true }).isURL({ require_protocol: true }),
